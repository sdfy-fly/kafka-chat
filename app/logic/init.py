...
from app.infra.repositories.chat.mongo import get_chat_mongodb_repository
...
def _init_container() -> Container:
    container = Container()
    container.register(BaseChatRepository, factory=get_chat_mongodb_repository, scope=Scope.singleton)
